...
<li><strong>TODO:</strong> Implement a ticket buying modal which opens on clicking an event. Add tickets dates collection to MongoDB, where, if a ticket is bought it will update in the database. Add token system to add separate roles for buyer and seller.</li>
